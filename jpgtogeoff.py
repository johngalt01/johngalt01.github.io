...
# designed for the GEOFF TERMINAL
...
# python -m py_compile jpgtogeoff 
# creates jpgtogeoffc
# make sure to change permissions to allow it to run : chmod +x jpgtogeoffc

# best usage for GEOFF Terminal 'jpgtogeoffc %f A T 0 0 100 0 1'
...
print(esc+"[Z8;"+str(offsetx)+";"+str(offsety)+";"+str(w+offsetx-1)+";"+str(h+offsety-1)+"Z")
print(esc+"[H")
#print(esc+"_GPEN255;255;255")
#print(esc+"_GRECT"+str(offsetx)+";"+str(offsety)+";"+str(w+offsetx-1)+";"+str(h+offsety-1))
print(esc+"[Z2;"+str(offsetx)+";"+str(offsety)+";"+str(w+offsetx-1)+";"+str(h+offsety-1)+"Z")
    ...
    for j in range(h):
       ...
       if arg3=="T" or arg3=="t":
        ...
        if pix[i,j][0]!=0 and pix[i,j][1]!=0 and pix[i,j][2]!=0:
         ...
         print(esc+"[Z1;"+str(i+offsetx)+";"+str(j+offsety)+";"+str(i+offsetx)+";"+str(j+offsety)+"Z")
